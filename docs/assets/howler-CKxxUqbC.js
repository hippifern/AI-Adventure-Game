import { c as S, g as G } from "./index-Dzi3WMm0.js";
function E(b, g) {
        ...
        (function () {
          ...
          u.prototype = {
                  ...
                  try {
                    ...
                    if (
                      ...
                      (x instanceof Promise || typeof x.then == "function")
                        ...
                        : t ||
                          ((n._playLock = !1), I(), n._emit("play", a._id)),
                      (v.playbackRate = a._rate),
                      v.paused)
                    ) {
                      n._emit(
            ...
            loop: function () {
              ...
              if (t.length === 1)
                if (typeof t[0] == "boolean") ((n = t[0]), (e._loop = n));
                  ...
                  return (
                    (_ = e._soundById(parseInt(t[0], 10))),
                    _ ? _._loop : !1
                  );
            ...
            _emit: function (e, t, n) {
              for (
                var o = this, _ = o["_on" + e], l = _.length - 1;
                l >= 0;
                l--
              )
              ...
              return function (u) {
                ...
                return (
                  ...
                  (i._pannerAttr = {
                    ...
                    coneOuterGain:
                      typeof u.coneOuterGain < "u" ? u.coneOuterGain : 0,
                    distanceModel:
                      typeof u.distanceModel < "u"
                        ? u.distanceModel
                        : "inverse",
                    maxDistance:
                      typeof u.maxDistance < "u" ? u.maxDistance : 1e4,
                    panningModel:
                      typeof u.panningModel < "u" ? u.panningModel : "HRTF",
                    refDistance: typeof u.refDistance < "u" ? u.refDistance : 1,
                    rolloffFactor:
                      typeof u.rolloffFactor < "u" ? u.rolloffFactor : 1,
                  }),
...
var B = V();
const C = G(B),
  q = E({ __proto__: null, default: C }, [B]);
export { q as h };
